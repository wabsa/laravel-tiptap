<div
    x-data="tiptapEditor(
        ...
        {{ $attributes->wire('model')->hasModifier('defer') ? '.defer': '' }},
        {
            enableImageUpload: @json($attributes->has('enable-image-upload')),
            maxSize: @json(config('laravel-tiptap.images.maxSize'))
        }
    )"
    wire:ignore
